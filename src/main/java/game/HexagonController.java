...
public class HexagonController {
    ...
    /**
     * Initializes the HexagonController object.
     */
    ...
    /**
     * Tries to place a bubble in the structure if no bubble is there already.
    ...
    /**
     * Tries to place a bubble in the structure if no bubble is there already.
     * The bubble gets generated by means of a bubbleMap.
     * @param x the x coordinate.
     * @param y the y coordinate.
     */
    ...
    /**
     * Uses the grid to set the proper positions of all the bubbles.
     */
    ...
    */
    ...
    /**
     * Pops all the bubbles that are not connected to the center element.
     */
